<?php
    Class CodegaUpdater extends AddonModule {
        ...
        public function adminArea()
        {
            ...
            $variables = [
                'link'              => $this->area_link,  /* https://***..com/admin/tools/addons/CodegaUpdater */
                'dir_link'          => $this->url,       /* https://***..com/coremio/modules/Addons/CodegaUpdater/ */
                'dir_path'          => $this->dir,      /* /-- DOCUMENT ROOT --/coremio/modules/Addons/CodegaUpdater/ */
                'dir_name'          => $this->_name,    /* CodegaUpdater, */
        ...
        public function clientArea()
        {
            ...
            $variables = [
                'link'              => $this->area_link,  /* https://***..com/addon/CodegaUpdater/client */
                'dir_link'          => $this->url,       /* https://***..com/coremio/modules/Addons/CodegaUpdater/ */
                'dir_path'          => $this->dir,      /* /-- DOCUMENT ROOT --/coremio/modules/Addons/CodegaUpdater/ */
                'dir_name'          => $this->_name,    /* CodegaUpdater, */
                'name'              => $this->lang["meta"]["name"], /* Sample Addon */
        ...
        public function upgrade(){
            ...
            {
                /*
                 * Modules::$init->db->query("ALTER TABLE md_CodegaUpdater ADD test1 varchar(255);"); # PDO::query()
                */
            }
            elseif($this->config["meta"]["version"] < 1.2)
            {
                /*
                 * Modules::$init->db->query("ALTER TABLE md_CodegaUpdater ADD test2 varchar(255);"); # PDO::query()
                */
            }
